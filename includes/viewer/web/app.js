...
let ExternalServices, initCom, MLManager;
if (typeof PDFJSDev === "undefined" || PDFJSDev.test("GENERIC")) {
  // Import the module normally if in a GENERIC build.
  ({ ExternalServices, initCom, MLManager } = await import("./genericcom.js"));
} else {
  // Otherwise, provide dummy implementations.
...
if (typeof PDFJSDev === "undefined") {
  window.PDFJSDev = {
    eval: function (code) {
      if (code === "BUNDLE_VERSION") return "4.10.38"; // or your actual version
      if (code === "BUNDLE_BUILD") return "4.10.38"; // or your actual build identifier
      return null;
    },
    test: function () {
      return false;
...
const PDFViewerApplication = {
  ...
  get pagesCount() {
    return this.pdfDocument ? this.pdfDocument._pdfInfo.numPages : 0;
  },
