...
import { AnnotationEditorType, ColorPicker, noContextMenu } from "./pdfjs.js";
import {
  DEFAULT_SCALE,
  DEFAULT_SCALE_VALUE,
  MAX_SCALE,
...
class Toolbar {
  ...
  #updateUIState(resetNumPages = false) {
    ...
    if (resetNumPages) {
      ...
      opts.numPages.textContent = `of ${pagesCount}`;
    }
...
// But that code is not smoothely updating the scaling value in attribute and secondly it should update the value of element
export { Toolbar };
